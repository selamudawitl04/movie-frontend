                    ...
                    <div class="flex flex-col lg:flex-row lg:space-x-12 justify-center  ">
                        ...
                        <div class=" my-6">
                            <div class="">
                                ...
                                <h2 class=" text-white text-6xl font-bold">The Easy <span class=" text-yellow-bright">{{ lastword }}</span></h2>
                                <div class="banner-meta">
                                    <ul class=" my-6 flex flex-wrap items-stretch ">
                                        ...
                                        <p class=" text-white mx-2 py-1">
                                            <a v-for="genere in props.movie.generes" :key="genere" href="#">{{ genere }},</a>
                                        </p>
                                        <span class=" text-white mx-2 pt-1"><i class="far fa-calendar-alt"></i>{{ props.movie.date }}</span>
                                        <span class=" text-white pt-1"><i class="far fa-clock"></i>{{ props.movie.duration }}</span>
                                    </ul>
                                </div>
