...
const unselectActor = (actor)=>{  
    selectedActors.value = selectedActors.value.filter(selectedActor=> selectedActor != actor)
}
                    ...
                    <UploadMultiImage></UploadMultiImage>
                     ...
                     <div class="flex justify-between">
                        <div class=" text-primary9">
                            ...
                            <div class=" my-2 flex flex-nowrap items-center justify-between space-x-2" v-for=" val  in selectedActors" :key="val">
                                <transition-group name="actorss">
                                <p class=" text-left border rounded-md px-2" >
                                 {{ val }}
                                </p>
                                <img @click="unselectActor(val)" class="w-7 cursor-pointer" src="../../assets/img/cancel-close-delete-svgrepo-com.svg" alt="">
