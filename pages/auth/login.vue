...
definePageMeta({
 ...
 function handleLogin() {
   ...
   authStore.login(variables.value).then((result) => {
   if (result) {
     console.log('Selamu Dawit Selemoon Tema', )
     router.push({ path: "/" });
   }
   }).catch((err) => {
 ...
 <div class="login">
     ...
     <base-dialog :show="someThingWrong" @click="someThingWrong=false" title="Some thing Went Wrong"></base-dialog>
         ...
         <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
             ...
             <div class="flex justify-center self-center  z-10">
                 <div class="p-12 bg-white mx-auto rounded-3xl w-100">
                     ...
                     <div class="space-y-5">
                         <Form class="space-y-5" @submit="handleLogin" :validation-schema="schema" v-slot="{ errors }">
                         ...
                         <div class="flex items-center justify-between space-x-7">
                             ...
                             <div class="text-sm">
                                 <router-link to="forgotPassword" href="#" class="text-orange-400 hover:text-orange-600">
